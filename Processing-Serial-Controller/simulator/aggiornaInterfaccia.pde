void aggiornaInterfaccia()
{
  ...
  graficoProfiloSfondo.beginDraw();
    ...
    int line_ph_x         = round(map(Integer.valueOf(DURATION_PH), 0, 30, 0, stepX));
    int line_soak_x       = round(map(Integer.valueOf(DURATION_SOAK), 0, 30, 0, stepX));
    int line_refl_peak_x  = round(map(Integer.valueOf(DURATION_REFLOW_RAMPUP), 0, 30, 0, stepX));
    ...
    */
    ...
    graficoProfiloSfondo.line(startX+line_ph_x,             stopY+30,startX+line_ph_x            , startY);
    graficoProfiloSfondo.line(startX+line_ph_x+line_soak_x, stopY+30,startX+line_ph_x+line_soak_x, startY);
    graficoProfiloSfondo.line(startX+stepX*10,stopY+30,startX+stepX*10,startY);
