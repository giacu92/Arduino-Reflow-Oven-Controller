...
public void buttonSetTemp_click(GButton source, GEvent event)
{
  ...
  int d_preheat        = Integer.valueOf(tf_PH_DURATION.getText());
  int d_soak           = Integer.valueOf(tf_SOAK_DURATION.getText());
  int d_reflow_rampup  = Integer.valueOf(tf_REFL_RU_DURATION.getText());
...
GTextField tf_PH_DURATION;
GTextField tf_SOAK_DURATION;
GTextField tf_REFL_RU_DURATION;
...
public void createGUI()
{
  ...
  tf_PH_DURATION = new GTextField(this, startX+50 , 110, 30, 20);
  tf_PH_DURATION.setText(Integer.toString(DURATION_PH));
  
  tf_SOAK_DURATION = new GTextField(this, startX+200, 110, 30, 20);
  tf_SOAK_DURATION.setText(Integer.toString(DURATION_SOAK));
  
  tf_REFL_RU_DURATION = new GTextField(this, startX+358, 110, 30, 20);
